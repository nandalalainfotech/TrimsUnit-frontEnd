...
export class ConsumbleManager extends BaseService {
    ...
    allconsumble() {
        return this.getCallService(`${this.consumbleUrl}` + "/findAll");
    }
    ...
    consumblePdf() {
        return this.getCallService1(`${this.consumbleUrl}` + "/pdf")
    }

    consumbleExcel() {
        return this.getCallService1(`${this.consumbleUrl}` + "/excel")
    }
}