...
export class FirstaidMaterialsManager extends BaseService {
    ...
    allfirstaid() {
        return this.getCallService(`${this.FirstaidUrl}` + "/findAll");
    }
    findeNotificationAll() {
        return this.getCallService(`${this.FirstaidUrl}` + "/findeNotificationAll");
    }
    ...
    fstaidplanPdf() {
        return this.getCallService1(`${this.FirstaidUrl}` + "/pdf")
    }
    fstaidplanExcel() {
        return this.getCallService1(`${this.FirstaidUrl}` + "/excel")
    }
}
